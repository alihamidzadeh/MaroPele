...
class GUI:
    ...
    def root_window(self):
        ...
        self.startButton = Button(self.root, text="New Game", background='#DB1F48', foreground='white',
        ...
        self.exitButton = Button(self.root, text="Exit", background='#DB1F48', foreground='white',
                                 font=("showcard gothic", 16, "bold"),
                                 command=self.exit)
